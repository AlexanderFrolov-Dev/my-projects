...
public class FindInFatalAndMoveToNewFile2 {
    private static final String SOURCE_ROOT_FOLDER_PATH = "C:\\Users\\Andrey Pakhomenkov\\Desktop\\20221114_1\\";
    private static final String TARGET_FOLDER_PATH = "C:\\Users\\Andrey Pakhomenkov\\Desktop\\20221114_1_2\\";
    ...
    private static void createFile(List<String> blocksOfSeparateRecord, File sourceFile) {
        ...
        try {
            ...
            if (!firstLine.isEmpty()) {
                writer.write(firstLine.concat(System.lineSeparator()));
            }
