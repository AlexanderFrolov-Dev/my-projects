...
/*
1. Программа выбирает в итоговую таблицу только строки, из второй (более длинной) таблицы, которые не находит в первой
таблице, но не наоборот. Т. е. строки, которые есть во второй таблице, но нет в первой таблице, не будут включены в
результирующую таблицу сравнения. - ИСПРАВИЛ
 */

public class TestAppFrame16 extends JFrame {
    ...
    Map<Map<Integer, String>, Map<String, String>> m = new HashMap<>();
    ...
    public TestAppFrame16() throws HeadlessException {
